...
На кнопке это видно как `слышно 12 · 40%`. С быстрым локальным профилем
обработка опережает реальное время, поэтому смотреть можно сразу; с профилем
качества первые реплики зазвучат так же быстро, но зритель обгонит обработку.
